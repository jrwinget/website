...
categories: ["Blog"]
tags: ["cognitive load", "UI/UX", "behavioral science", "R", "shiny", "bidux", "BID"]
summary: 'Introducing {bidux}: A toolkit that helps developers design dashboards grounded in cognitive and behavioral science'
output:
  blogdown::html_page:
    toc: true
...
### 2️⃣ **Interpret the User's Needs**

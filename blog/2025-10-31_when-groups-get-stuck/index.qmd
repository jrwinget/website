...
![](img/broadview.png){.float-end .rounded .shadow-sm width="45%"}
...
![](img/pluralistic-ignorance.png){.float-end .rounded .shadow-sm width="45%"}
...
![](featured.png){.float-start .rounded .shadow-sm width="42%"}

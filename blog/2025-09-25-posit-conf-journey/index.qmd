...
![](img/signed-hadley.png){.float-start .rounded .shadow-sm width="33%" fig-alt="Photograph of a signed copy of the book R for Data Science by Hadley Wickham, obtained at posit::conf 2018 in San Diego"}
...
![](img/posit-stage.png){.float-end .rounded .shadow-sm width="65%" fig-alt="Speaker on stage at posit::conf 2025 presenting to an audience, speaking about behavioral science and tool design for improving user experience in software development"}

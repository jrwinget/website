...
It's been quite some time since I've written here, so I thought I would use one my of [2019 #rstats goals](https://twitter.com/_jwinget/status/1079437460357218304) as an excuse to brush off the dust. In this post, I analyze data from the Economist's "TV's golden age is real" data set for my **first** [#tidytuesday](https://github.com/rfordatascience/tidytuesday/tree/master/data/2019/2019-01-08) submission!

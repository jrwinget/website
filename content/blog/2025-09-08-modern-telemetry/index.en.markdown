...
categories: ["Blog"]
tags: ["UI/UX", "behavioral science", "R", "shiny", "bidux", "BID"]
summary: 'The {bidux} 0.3.1 release makes telemetry analysis in BID smoother, tidier, and more consistent; from raw issues to validated insights.'
output:
  blogdown::html_page:
    toc: true
